...
Preintegrated::Preintegrated(orb_slam3_ros::PreintegratedIMU Msg)
{
    b = Bias(Msg.b[0],Msg.b[1],Msg.b[2],Msg.b[3],Msg.b[4],Msg.b[5]);
    Initialize(b);
    Nga = cv::Mat::zeros(6,6,CV_32F);
    NgaWalk = cv::Mat::zeros(6,6,CV_32F);
    dT= Msg.dT;
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_C_type,float>(C,Msg.C);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_Nga_type,float>(Nga,Msg.Nga);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_NgaWalk_type,float>(NgaWalk,Msg.NgaWalk);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_dR_type,float>(dR,Msg.dR);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_dV_type,float>(dV,Msg.dV);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_dP_type,float>(dP,Msg.dP);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_JRg_type,float>(JRg,Msg.JRg);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_JVg_type,float>(JVg,Msg.JVg);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_JVa_type,float>(JVa,Msg.JVa);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_JPg_type,float>(JPg,Msg.JPg);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_JPa_type,float>(JPa,Msg.JPa);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_avgA_type,float>(avgA,Msg.avgA);
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_avgW_type,float>(avgW,Msg.avgW);
}
void Preintegrated::Update(orb_slam3_ros::PreintegratedIMU Msg){
//    std::cout<<"0,";
    dT= Msg.dT;
//    std::cout<<"1,";
    Converter::MsgArrayFixedSizeToCvMat<orb_slam3_ros::PreintegratedIMU::_C_type,float>(C,Msg.C);
