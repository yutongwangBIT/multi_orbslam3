...
public:
  ...
  /*  LoopClosing(CentralControl* pCC, Atlas* pAtlas, KeyFrameDatabase* pDB, ORBVocabulary* pVoc,const bool bFixScale);*/
    LoopClosing(CentralControl* pCC, Atlas* pAtlas, KeyFrameDatabase* pDB, ORBVocabulary* pVoc, eSensor sensor);
