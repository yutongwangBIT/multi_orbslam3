...
public:
    ...
    KeyFrame(Frame &F, Map* pMap, KeyFrameDatabase* pKFDB, Communicator* pComm, eSystemState sysState, size_t UniqueId);
    KeyFrame(orb_slam3_ros::KF* msg, Map* pMap, ORBVocabulary* mpVoc, KeyFrameDatabase* pKFDB, Communicator* pComm, eSystemState sysState, eSensor Sensor,
        GeometricCamera* Camera, size_t UniqueId=0, g2o::Sim3 mg2oS_wcurmap_wclientmap=g2o::Sim3(), const IMU::Calib &ImuCalib = IMU::Calib());

    // Pose functions
    void SetPose(const cv::Mat &Tcw, bool bLock=false, bool bLockSend=false);
    ...
    //CHNAGED FOR COMMUNICATION
    orb_slam3_ros::KF GetKFMessageClient();
    void SendMe();
    ...
    void ConvertToMessageServer(orb_slam3_ros::Map &msgMap, KeyFrame* pKFref, uint8_t nClientIdComm);
    void EstablishInitialConnections();

    void UpdateFromMessage(orb_slam3_ros::KFred *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap=g2o::Sim3(), bool bUpdateMPs=false);
...
public:
    ...
    std::vector<float> mvDepth; // negative value for monocular points //CHANGED FOR CONSTRUCT NEW KF
    cv::Mat mDescriptors;
    ...
    KeyFrame* mPrevKF;
    KeyFrame* mNextKF;
    KeyFrame* mPrevKFOri;//FOR ERASE KF
    cv::Mat mmTcPrev; //for erase kf
    cv::Mat mmTcPrevOri; //to save original tcp from client
...
protected:
    void WriteMembersFromMessage(orb_slam3_ros::KF* msg, g2o::Sim3 mg2oS_wcurmap_wclientmap);
    bool PosInGrid(const cv::KeyPoint &kp, int &posX, int &posY);
    void AssignFeaturesToGrid();
    void ReduceMessage(orb_slam3_ros::KF *pMsgFull, orb_slam3_ros::KFred *pMsgRed);
    bool SetPoseFromMessage(orb_slam3_ros::KF *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap=g2o::Sim3());
    bool SetPoseFromMessage(orb_slam3_ros::KFred *pMsg, g2o::Sim3 mg2oS_wcurmap_wclientmap=g2o::Sim3());
    void ConvertToImuMessage(orb_slam3_ros::PreintegratedIMU &msg_imu);
    ...
    std::mutex mMutexMap;
    std::mutex mMutexOut; //for communication
    std::mutex mMutexBadFlag; //try
...
public:
    ...
    int NLeft, NRight; //CHANGED FOR CONSTRUCT NEW KF
