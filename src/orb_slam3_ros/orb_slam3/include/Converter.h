...
#include "orb_slam3_ros/CvKeyPoint.h"
...
public:
    ...
    static orb_slam3_ros::CvKeyPoint toCvKeyPointMsg(const cv::KeyPoint &kp);
    static cv::KeyPoint fromCvKeyPointMsg(const orb_slam3_ros::CvKeyPoint &Msg);
