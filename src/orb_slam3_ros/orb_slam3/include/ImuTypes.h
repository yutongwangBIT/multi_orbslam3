...
#include "orb_slam3_ros/KF.h" //for server reconstuct the preintegration class
...
public:
    ...
    Preintegrated(orb_slam3_ros::PreintegratedIMU Msg);
    Preintegrated() {}
    ~Preintegrated() {}
    ...
    void Update(orb_slam3_ros::PreintegratedIMU Msg);
