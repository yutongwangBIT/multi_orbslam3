...
int main(int argc, char **argv)
{
    ...
    MonoNode node (ORB_SLAM3::MONOCULAR, node_handle, image_transport);
...
MonoNode::MonoNode (ORB_SLAM3::eSensor sensor, ros::NodeHandle &node_handle, image_transport::ImageTransport &image_transport){
